...
var Axis = (SRC.Chart.Axis = class Axis {
  ...
  __calculateScale(min, max, valueMinDiff) {
    ...
    if (this._scaleType === SRC.Chart.ScaleType.DateTime) {
      this._internalInterval =
        SR.isDefined(this._interval) && SR.isDefined(this._intervalType)
          ? Axis.intervalType2Ms(this._intervalType, this._interval)
          : valueMinDiff;
    } else {
...
Axis.intervalType2Ms = function (intervalType, interval) {
    switch (intervalType) {
        ...
        case Axis.intervalType.Year: return interval * 31536000000;
        case Axis.intervalType.Month: return interval * 2592000000;
        case Axis.intervalType.Day: return interval * 86400000;
        case Axis.intervalType.Hour: return interval * 3600000;
        case Axis.intervalType.Minute: return interval * 60000;
        case Axis.intervalType.Second: return interval * 1000;
