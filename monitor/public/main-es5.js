  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function Ey2G(module, __webpack_exports__, __webpack_require__) {
      ...
      ServerConfigComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 35,
        vars: 6,
        consts: [["mat-dialog-title", ""], [1, "mat-typography"], [1, "nostyle"], ["matInput", "", 3, "value", "change"], ["matInput", "", "resizeToFitContent", "true", 3, "value", "change"], [1, "full-width"], ["align", "end"], ["mat-button", "", "mat-dialog-close", ""], ["mat-button", "", "cdkFocusInitial", "", 3, "mat-dialog-close"]],
        template: function ServerConfigComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](30, "mat-dialog-actions", 6);
      ...
      NavBarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function NavBarComponent_Template(rf, ctx) {
          ...
          if (rf & 2) {
            ...
            var _r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](34);
    ...
    function hUZ4(module, __webpack_exports__, __webpack_require__) {
      ...
      var ServerComponent = /*#__PURE__*/function () {
        function ServerComponent(route, router) {
        ...
        _createClass(ServerComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.queryParams.subscribe(function (params) {
              _this4.server.agent_id = params['agent_id'];
            });
          }
        }]);
      ...
      ServerComponent.ɵfac = function ServerComponent_Factory(t) {
        return new (t || ServerComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]));
      };
    ...
    function jL0J(module, __webpack_exports__, __webpack_require__) {
      ...
      var Server = /*#__PURE__*/function () {
        function Server(agent_id, details, ip, cpu_count, platform, stats_interval_ms, watch_process, last_updated_ts) {
        ...
        _createClass(Server, [{
          ...
          value: function clone(server) {
            return new Server(server.agent_id || '', server.ip || '', server.details || '', server.cpu_count || 0, server.platform || '', server.stats_interval_ms || 5000, server.watch_process || [], server.last_updated_ts || 0);
          }
        }]);
      ...
      var ServersService = /*#__PURE__*/function () {
        ...
        _createClass(ServersService, [{
          ...
          value: function updateServer(agent_id, server) {
            var url = 'http://localhost:2600/agent/update/' + agent_id;
          ...
          value: function addServer(server) {
            var url = 'http://localhost:2600/agent/add';
            return this.http.post(url, server).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError)).toPromise();
          }
        }, {
          key: "handleError",
