...
class ServerComponent {
    ...
    createHistoryGraph(id, yAxisSettings) {
        return new Chart(id, {
            // width: 300, height: 160,
            border: this.borderThickness,
            bevel: false,
    ...
    createOrUpdateHistoryGraph(id, chartData, unit, yAxisSettings) {
        let chart;
        switch (id) {
