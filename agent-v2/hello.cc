...
static const string topMemory = "cat /tmp/youknow_sys.tmp | awk -v QT='\"' 'FNR==4 {print \"{\" QT \"app\" QT \":\" QT \"sys\" QT \", \" QT \"mem_total\" QT \":\" $4*1.024 \", \" QT \"mem_free\" QT \":\" $6*1.024 \", \" QT \"mem_used\" QT \":\" $8*1.024 \", \" QT \"mem_buff_cache\" QT \":\" $10*1.024 \"}\"}'";
static const string topSwapMemory = "cat /tmp/youknow_sys.tmp | awk -v QT='\"' 'FNR==5 {print \"{\" QT \"app\" QT \":\" QT \"sys\" QT \", \" QT \"mem_swap_total\" QT \":\" $3*1.024 \", \" QT \"mem_swap_free\" QT \":\" $5*1.024 \", \" QT \"mem_swap_used\" QT \":\" $7*1.024 \", \" QT \"mem_swap_avail\" QT \":\" $9*1.024 \"}\"}'";
